<template>
  <div class="app-container">
    ...
    <book ref="book" v-if="this.currentComponents.book" message="lost"></book>
    <other ref="other" v-if="this.currentComponents.other" message="lost"></other>
    <udisk ref="udisk" v-if="this.currentComponents.udisk" message="lost"></udisk>
    <wallet ref="wallet" v-if="this.currentComponents.wallet" message="lost"></wallet>
  </div>
</template>
