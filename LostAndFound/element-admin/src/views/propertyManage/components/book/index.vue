    ...
    <div style="width:1050px">
      <el-table :data="list" border style="width: 100%">
        <el-table-column label="书籍" align="center">
          <el-table-column prop="date" label="日期" width="120px" sortable/>
...
<script>
import { getFoundBook, getLostBook } from "@/api/getList";
import { deletefoundBook, deletelostBook } from "@/api/deleteList";
    ...
    deleteRow: function() {
      new Promise((resolve, reject) => {
        ...
        if (this.message === "found") {
          deletefoundBook(this.list[this.rowIndex].id)
            .then(response => {
          ...
          deletelostBook(this.list[this.rowIndex].id)
            .then(response => {
              console.log(response.data);
              Message.success("删除成功");
              this["Get" + this.message + "Book"]();
